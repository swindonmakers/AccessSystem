package HTML::FormHandler::Widget::Theme::ASBootstrap4;
...
Sample Bootstrap4 theme role. Can be applied to your subclass of HTML::FormHandler.
...
Bootstrap4 theme. The heavy lifting is done by the Bootstrap4 wrapper,
L<HTML::FormHandler::Widget::Wrapper::Bootstrap4>,
which you can use by itself in your form with:

    has '+widget_wrapper' => ( default => 'Bootstrap4' );

It also uses L<HTML::FormHandler::Widget::Theme::BootstrapFormMessages4>
...
use Moose::Role;
with 'HTML::FormHandler::Widget::Theme::ASBootstrapFormMessages4';

after 'before_build' => sub {
    my $self = shift;
    $self->set_widget_wrapper('ASBootstrap4')
