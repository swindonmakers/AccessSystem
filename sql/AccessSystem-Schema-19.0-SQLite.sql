...
-- Created on Sun Aug 30 21:06:45 2026
--
...
CREATE TABLE tools (
  ...
  lone_working_allowed boolean NOT NULL DEFAULT true,
...
CREATE UNIQUE INDEX trn ON transactions (fitid);
...
--
DROP TABLE person_transactions;
