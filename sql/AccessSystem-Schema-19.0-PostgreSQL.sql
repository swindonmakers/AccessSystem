...
-- Created on Sun Aug 30 21:11:06 2026
--
--
...
CREATE TABLE tools (
  ...
  lone_working_allowed boolean DEFAULT true NOT NULL,
...
--
-- Table: required_tools
--
DROP TABLE required_tools CASCADE;
...
--
-- Table: person_transactions
--
DROP TABLE person_transactions CASCADE;
...
CREATE INDEX person_transactions_idx_person_id on person_transactions (person_id);
CREATE INDEX person_transactions_idx_transaction_id on person_transactions (transaction_id);
...
CREATE TABLE usage_log (
  ...
  running_for integer DEFAULT 0 NOT NULL,
...
ALTER TABLE person_transactions ADD CONSTRAINT person_transactions_fk_person_id FOREIGN KEY (person_id)
  REFERENCES people (id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE;
