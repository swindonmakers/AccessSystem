...
-- Created on Sun Aug 30 21:11:07 2026
--
...
CREATE TABLE tools (
  ...
  requires_induction enum('0','1') NOT NULL DEFAULT false,
  lone_working_allowed enum('0','1') NOT NULL DEFAULT true,
...
CREATE TABLE allowed (
  person_id integer NOT NULL,
  inducted_by_id integer NULL DEFAULT NULL,
  tool_id varchar(40) NOT NULL,
  is_admin enum('0','1') NOT NULL DEFAULT 'false',
  pending_acceptance enum('0','1') NOT NULL DEFAULT 'true',
  accepted_on datetime NULL,
  added_on datetime NOT NULL,
  INDEX allowed_idx_inducted_by_id (inducted_by_id),
  INDEX allowed_idx_person_id (person_id),
  INDEX allowed_idx_tool_id (tool_id),
  PRIMARY KEY (person_id, tool_id),
  CONSTRAINT allowed_fk_inducted_by_id FOREIGN KEY (inducted_by_id) REFERENCES people (id),
